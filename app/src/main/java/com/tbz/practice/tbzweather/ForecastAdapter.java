package com.tbz.practice.tbzweather;
...
import com.tbz.practice.tbzweather.forcastResponse.ForecastResponse;
import com.tbz.practice.tbzweather.forcastResponse.List;
...
public class ForecastAdapter extends ArrayAdapter{
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        picasso.with(context).load(MainActivity.BASE_URL_OF_ICON
                +forecastList.get(position).getWeather().get(0).getIcon()+MainActivity._PNG).into(iconIv);
